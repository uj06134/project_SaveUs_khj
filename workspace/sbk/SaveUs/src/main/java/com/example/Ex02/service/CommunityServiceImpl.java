...
public class CommunityServiceImpl implements CommunityService {
    ...
    private final String UPLOAD_DIR = "src/main/resources/static/uploads/posts/";


    @Override
    public List<CommunityPostDto> getPostList(Long currentUserId) {
        List<CommunityPostDto> postList = communityMapper.selectPostList(currentUserId);
...
//            throw new AccessDeniedException("You are not the owner of this comment");
    ...
    @Override
    public List<CommunityPostDto> getPopularPostList(Long currentUserId) {
        // 1. DB에서 오늘 인기순 목록 조회
        List<CommunityPostDto> postList = communityMapper.selectPopularPostList(currentUserId);
